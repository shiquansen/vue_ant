...
<template>
    <div class="container">
        <div class="loginBox">
            <a-form-model :model="formdata" :rules="rules" ref="loginFormRef" class="loginForm">
                ...
                <a-form-model-item class="loginBtn">
                    <a-button type="primary" style="margin: 0 20px;" @click="login()">登录</a-button>
                    <a-button type="info" style="margin: 0 20px;" @click="reset()">取消</a-button>
                </a-form-model-item>
            </a-form-model>
        </div>
            ...
            return {
                ...
                rules: {
                    username: [
                        ...
                        { min: 4, max: 12, message: '用户名在6到12字符之间', trigger: 'blur' },
                    ],
                    password: [
                        { required: true, message: '请输入密码', trigger: 'blur' },
                        { min: 4, max: 20, message: '密码在6到20字符之间', trigger: 'blur' },
                    ],
                }
            }
        },
